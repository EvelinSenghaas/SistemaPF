...
from .views import Rutinas, ListadoRutinas, ListadoActividades, EditarRutina, EditarActividad, EliminarActividad, AgregarRutina, AgregarDetalle, AgregarActividad, EliminarRutina, verRutina
...
urlpatterns = [
    ...
    path('eliminar_actividad/<int:pk>', login_required(EliminarActividad.as_view(success_url="/rutinas/")), name='eliminar_actividad'), 
