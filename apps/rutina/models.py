...
class RevisionSesion(models.Model):
    ...
    sesion_id = models.ForeignKey(Sesion, on_delete=models.CASCADE)
    nivelAnterior = models.CharField(max_length = 60, blank = False, null = False, verbose_name="Nivel anterior")
    nivelRevision = models.CharField(max_length = 60, blank = False, null = False, verbose_name="Nivel revision")
